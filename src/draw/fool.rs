...
fn nodes() -> Vec<Node<'static>> {
    vec![
        ...
        Node("BackElbow", 0.2, 6.8),
        Node("BackHand", -0.6, 10.8),
        Node("BackInnerElbow", 0.9, 7.0),
        Node("BackArmpit", 2.5, 4.9),
        Node("BackWaist", 3.0, 8.0),
        Node("Groin", 5.8, 9.0),
        // Node("FrontKneeTop", 8.5, 10.1),
        // Node("FrontKneeBottom", 8.9, 10.9),
        Node("FrontKnee", 9.3, 10.2),
        Node("FrontAnkle", 7.8, 14.6),
        Node("FrontToes", 9.35, 15.0),
        Node("FrontHeel", 7.0, 15.4),
        Node("FrontInnerKnee", 7.7, 11.2),
        Node("Root", 4.5, 10.8),
